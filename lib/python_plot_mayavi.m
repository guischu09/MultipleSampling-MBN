...
function [command] = python_plot_mayavi(pythonFilename,r_RepresentativeMatrix,atlas_filename,CoordsFilename,OutputFormat, OutputFolder, brain_type, outputFilename,colormap,setup)
...
command = ['python ' pythonFilename ' --vmin ' vmin ' --vmax ' vmax ' --size_cte ' size_cte ...
    ...
    ' --out_bp ' out_bp ' --out_hm ' out_hm ' --out_fd ' out_fd ' --brain_type ' brain_type ' --cmap ' cmap];
