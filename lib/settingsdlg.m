...
% https://www.paypal.me/RodyO/3.5
    ...
    if (narg == 1)
        ...
        parameters = varargin(1+have_settings : 2 : end-1);
        values     = varargin(2+have_settings : 2 : end-1);
        Tips = varargin{end};
    end
    % Initialize data
    button = [];
...
edit_bgcolor = 'White';
    ...
    total_width   = getValue(400, 'WindowWidth');
    ...
    if num_separators > 0
        ...
        text_width = (total_width-control_width-10);
    end
    % Handle description
